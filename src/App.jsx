    ...
    <main className={`${darkMode ? 'bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white' : 'bg-white text-black'} min-h-screen font-sans p-4 sm:p-6 md:p-12 scroll-smooth transition-colors duration-500`}>
      ...
      >
        ...
        <motion.section id="skills" variants={fadeInUp}>
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-400 border-b border-gray-700 pb-2 mb-6">Skills</h2>
          <ul className="grid sm:grid-cols-2 gap-4 text-gray-300 text-sm">
            ...
            <li><strong>Testing Expertise:</strong> Component testing (C#), End-to-end testing, REST API testing, Load testing</li>
        ...
        <motion.section id="experience" variants={fadeInUp}>
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-400 border-b border-gray-700 pb-2 mb-6">Experience</h2>
        ...
        <motion.section id="projects" variants={fadeInUp}>
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-400 border-b border-gray-700 pb-2 mb-6">Projects</h2>
          <div className="text-gray-300 text-sm space-y-4">
            <div>
              <strong>Operating System Project – </strong>
              <a href="https://github.com/mnalam2/OperatingSystem/tree/master/student-distrb" className="text-cyan-400 hover:underline" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
              <p>Developed a full OS in x86/C with memory protection, file system, and I/O drivers.</p>
            </div>
            <div>
              <strong>AI Projects – </strong>
              <a href="https://github.com/mnalam2/Artificial-Intelligence-Projects" className="text-cyan-400 hover:underline" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
        ...
        <motion.section id="education" variants={fadeInUp}>
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-400 border-b border-gray-700 pb-2 mb-6">Education</h2>
        ...
        <motion.section id="contact" className="text-center" variants={fadeInUp}>
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-400 border-b border-gray-700 pb-2 mb-6">Contact</h2>
